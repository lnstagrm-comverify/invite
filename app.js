...
function showTransactionModal(transaction) {
    ...
    const recipientDetail = data.username || data.purpose || 'cashapp';
    document.getElementById('telegram-recipient-detail').textContent = recipientDetail.startsWith('@') ? recipientDetail : `@${recipientDetail}`;
